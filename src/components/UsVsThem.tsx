      ...
      `}</style>
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl lg:text-5xl font-serif text-slate-900 leading-tight mb-4">
                    ...
                    <div className="relative bg-white/80 backdrop-blur-xl rounded-2xl border border-slate-200 overflow-hidden shadow-xl">
                        ...
                        <div className="grid grid-cols-9 bg-slate-100 border-b border-slate-200">
                            ...
                            {tools.map((tool, i) => (
                                <div
                                    key={i}
                                    className={`p-4 lg:p-5 text-center border-l border-slate-200 ${i === 0 ? 'bg-emerald-50' : ''}`}
                                >
                                    {i === 0 ? (
                                        <span className="text-sm font-bold text-emerald-600">{tool}</span>
                                    ) : (
                        ...
                        {features.map((feature, index) => (
                            ...
                            >
                                ...
                                {feature.values.map((has, i) => (
                                    <div
                                        key={i}
                                        className={`p-4 lg:p-5 flex items-center justify-center border-l border-slate-100 ${i === 0 ? 'bg-emerald-50/50' : ''}`}
                                    >
                                        {has ? (
                                            <div className="w-7 h-7 rounded-lg flex items-center justify-center bg-emerald-500 shadow-lg shadow-emerald-500/30">
                ...
                <div className="mt-12 text-center">
                    ...
                    <button className="px-6 py-3 bg-[#1A1A1A] hover:bg-black text-white rounded-full font-medium transition-all shadow-xl shadow-emerald-900/5 hover:shadow-emerald-900/10 text-sm inline-flex items-center">
